...
module.exports = postcss.plugin('postcss-px-to-viewport', function(options) {
  ...
  return function(css) {
    css.walkDecls(function(decl, i) {
      ...
      // zyy add
      if (opts.selectorWhiteList && opts.selectorWhiteList.length>0 && !whitelistedSelector(opts.selectorWhiteList, decl.parent.selector))return;
...
// TODO:
function whitelistedSelector(whitelist, selector) {
